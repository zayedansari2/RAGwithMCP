...
def get_api_key() -> str:
    ...
    if not key:
        raise ValueError(
            "OPEN_ROUTER_API_KEY is not set. "
...
def rag_chat(
    ...
    if context_chunks:
        ...
        system_prompt = (
            ...
            "say so clearly and answer from your general knowledge if possible.\n\n"
            f"Context:\n{context_block}"
        )
    else:
        system_prompt = (
            "You are a helpful assistant. No relevant context was found in the "
            "knowledge base for this question. Answer using your general knowledge."
        )
